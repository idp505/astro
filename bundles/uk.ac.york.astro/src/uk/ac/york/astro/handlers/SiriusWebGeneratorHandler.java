...
import uk.ac.york.astro.Sirius2SiriusWeb;
import uk.ac.york.astro.util.UtilityService;


public class SiriusWebGeneratorHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selection0 instanceof IStructuredSelection) {
			...
			if (odesign != null && metamodel != null && generatorParameters != null) {
				Sirius2SiriusWeb job = new Sirius2SiriusWeb(odesign, metamodel, generatorParameters);
				job.setUser(true);
				job.schedule();
			}
		}
